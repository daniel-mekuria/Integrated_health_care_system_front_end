...
const PDDTF = () => {
    ...
    return (
        <div className='flex flex-col m-5 p-5  mr-20'>
            <form action="">
                <div className='flex flex-col mb-5'>
                    ...
                    <div>
                        <label htmlFor="atrNumber" className='font-bold'>ATR Number: </label>
                    ...
                    <div className=''>
                        ...
                        <div className='flex flex-row gap-52'>
                            <div className='flex flex-col'>
                                ...
                                <input type="date" id="date" className="border rounded w-96 p-2 outline-none focus:border-blue-500" />
                            </div>
                            <div className='flex flex-col'>
                                <label htmlFor="">Prescription Number</label>
                                <input type="text" placeholder='prescription number' id="prescription_number" className="border rounded p-2 w-96 outline-none focus:border-blue-500" />
                            </div>
                        </div>
                        ...
                        <div className='flex flex-row gap-20'>
                            ...
                            <div className='flex flex-col '>
                                ...
                                <input type="text" placeholder='weight' id="weight" className="border rounded p-2 outline-none focus:border-blue-500" />
                            </div>

                            <div className='flex flex-col ml-28'>
                                <label htmlFor="">Month of supply </label>
                                <input type="text" id="month_of_supply" placeholder='month of supply' className="border rounded p-2 outline-none focus:border-blue-500" />
                            </div>
                        ...
                        <div className='flex flex-row gap-20'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <input type="text" id="prescription_name" placeholder='prescription name' className="border rounded p-2 outline-none focus:border-blue-500" />
                            </div>
                        ...
                        <div className='flex flex-row gap-20'>
                            <div className='flex flex-col'>
                                ...
                                <FormControl>
                                    ...
                                    <Select
                                        ...
                                        renderValue={(selected) => {
                                            ...
                                            return selected.map((value) => drugNames[value]).join(', ');
                                        }}
                                        className='w-72'
                                    >
                                        <MenuItem value="option1">
                                            <Checkbox checked={options.option1} onChange={handleOptionChange} name="option1" />
                                            TDF/3TC/DTG 
                                        </MenuItem>
                                        <MenuItem value="option2">
                                            <Checkbox checked={options.option2} onChange={handleOptionChange} name="option2" />
                                            TDF/3TC/DTG 600
                                        </MenuItem>
                                        <MenuItem value="option3">
                                            <Checkbox checked={options.option3} onChange={handleOptionChange} name="option3" />
                                            TDF/3TC/DTG 400
                                        </MenuItem>
                                        <MenuItem value="option4">
                                            <Checkbox checked={options.option4} onChange={handleOptionChange} name="option4" />
                                            ZDV/3TC/DTG
                                        </MenuItem>
                                        <div className='flex flex-row'>
                                        <MenuItem >
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <input type="text" id="strength" placeholder='strength' className="border rounded p-2 outline-none focus:border-blue-500" />
                                </div>

                                <div className='flex flex-col'>
                                    <label htmlFor="">Quality </label>
                                    <input type="text" id="Quality" placeholder='Quality' className="border rounded p-2 outline-none focus:border-blue-500" />
                                </div>

                                <div className='flex flex-col'>
                                    <label htmlFor="">Brand </label>
                                    <input type="text" id="Brand" placeholder='brand' className="border rounded p-2 outline-none focus:border-blue-500" />
                                </div>
                        ...
                        <div className='flex flex-row gap-20'>
                            <div className='flex flex-col'>
                                <div className='flex flex-col pt-6'>
                                    <label htmlFor="">Service Delivery(Other, ASM, FTR,CAG,etc) </label>
                                    <input type="text" placeholder='strength' id="service_delivery" className="border rounded p-2 outline-none focus:border-blue-500" />
                                </div>
                            </div>
                            <div className='flex flex-col pt-6'>
                                <label htmlFor="">Other Drugs dispensed</label>
                                <input type="text" placeholder='Drug dispensed' id="other_drug_dispensed" className="border rounded p-2 outline-none focus:border-blue-500" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='flex flex-row justify-center '>
                    <h2 className='font-bold'>February 2022</h2>
                </div>
                <div className='flex flex-row justify-center mt-5'>
                    <button className="bg-green-800 text-white py-2 px-8 rounded-md">Done</button>
                </div>
            </form>
        </div>
    );
