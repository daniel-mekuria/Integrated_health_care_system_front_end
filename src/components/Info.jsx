        ...
        <div className="flex flex-wrap px-6 pt-4">
          <div className="w-full md:w-1/4">
            <div className="mb-4">
              ...
              <dd className="mt-1 text-sm text-gray-900">{data.firstName + data.lastName}</dd>
            </div>
          </div>
          <div className="w-full md:w-1/4">
            <div className="mb-4">
          ...
          <div className="w-full md:w-1/4">
            <div className="mb-4">
              ...
              <dd className="mt-1 text-sm text-gray-900">{data.dateOfBirth}</dd>
            </div>
          </div>
          <div className="w-full md:w-1/4">
            <div className="mb-4">
          ...
          <div className="w-full md:w-1/4">
            <div className="mb-4">
              ...
              <dd className="mt-1 text-sm text-gray-900">{data.telephoneNo}</dd>
            </div>
          </div>
          <div className="w-full md:w-1/4">
            <div className="mb-4">
